...
mgc_filt = mgc_scrape.apply_filter(img_mgc_raw)
mgc_read = mgc_scrape.read_card(mgc_filt)
# print(mgc_read)
...
ygo_filt = ygo_scrape.apply_filter(img_ygo_raw)
ygo_read = ygo_scrape.read_card(ygo_filt)
# print(ygo_read)
...
pkm_filt = pkm_scrape.apply_filter(img_pkm_raw)
pkm_read = pkm_scrape.read_card(pkm_filt)
# print(pkm_read)