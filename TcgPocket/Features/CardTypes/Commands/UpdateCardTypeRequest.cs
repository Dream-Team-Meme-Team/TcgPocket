...
public class UpdateCardTypeRequest : IRequest<Response<CardTypeGetDto>>
{
    public int Id { get; set; }
    public CardTypeDto CardType { get; set; }
}

public class UpdateCardTypeRequestHandler : IRequestHandler<UpdateCardTypeRequest, Response<CardTypeGetDto>>
{
    private readonly DataContext _dataContext;
    private readonly IMapper _mapper;
    private readonly IValidator<UpdateCardTypeRequest> _validator;

    public UpdateCardTypeRequestHandler(DataContext dataContext,
        IValidator<UpdateCardTypeRequest> validator,
        IMapper mapper)
    {
    ...
    public async Task<Response<CardTypeGetDto>> Handle(UpdateCardTypeRequest request, CancellationToken cancellationToken)
    {
