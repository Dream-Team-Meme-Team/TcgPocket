            ...
            <div className={classes.wrapper}>
                <Container size={800} className={classes.inner} color="blue">
                    ...
                    <Text className={classes.description} color="dimmed">
                        Presenting a trading card game inventory management
                        system along with a deck builder. Just upload images of
                        your MTG, Pokémon, and Yu-Gi-Oh! cards and allow our
                        card scanner to add the cards to your inventory. Sign up
                        or log in to begin! (*^▽^*)
                    </Text>
